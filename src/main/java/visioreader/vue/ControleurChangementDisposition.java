 ...
 *   et le déplace dans l'AnchorPane
 ...
 * Pour ajouter une vue : à l'ouverture d'une vue, la vue se place automatiquement dans la première place disponible
 *
...
public class ControleurChangementDisposition implements Initializable {
    ...
    /** Label A : Orientation Horizontale / Verticale */
    @FXML
    private Label lbl_empA;

    /** Label B : Orientation Horizontale / Verticale */
    @FXML
    private Label lbl_empB;

    /** Label C : Orientation Horizontale / Verticale */
    @FXML
    private Label lbl_empC;

    /** Label D : Orientation Horizontale / Verticale */
    @FXML
